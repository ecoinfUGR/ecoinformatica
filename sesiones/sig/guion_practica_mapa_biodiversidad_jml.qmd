...
[Aquí](https://drive.google.com/file/d/1SsLrERuUbi1_vm6lxpHS-SyJkf6LIk5-/view?usp=sharing) puedes descargar la capa con los datos de presencia de especies de Sierra Nevada. Como ves más abajo, son unos cuantos miles de puntos...
...
5. Calcular el número de individuos por especie y por cuadrícula.

6. Calcular el número total de individuos por cuadrícula.

7. Calcular la proporción de individuos (*pi*) por especie y por cuadrícula.

8. Calcular el *log2 pi* por especie y por cuadrícula.

9. Calcular H por cuadrícula.
...
# Calcular el log2 pi por especie y por cuadrícula.
