...
```{r, eval = FALSE}
# Cargar máscara
mask <- raster("material/mascara_23030.tif")

# Cargar capas con las que vamos a trabajar: temperaturas, precipitaciones, aridez, aspecto, pendiente
tmax <- raster("material/tmax_1971_2000_23030_clipbyextent.tif")
tmin <- raster("material/tmin_1971_2000_23030_clipbyextent.tif")
prec <- raster("material/p_1971_2000_23030_clipbyextent.tif")
aridez <- raster("material/i_aridez_23030.tif")
aspecto <- raster("material/aspecto_23030.tif")
pendiente <- raster("material/pendiente_en_grados_23030.tif")
